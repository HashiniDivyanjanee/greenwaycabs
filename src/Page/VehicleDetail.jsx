...
const VehicleDetail = ({ onNavigate, onVehicleBookingClick }) => {
  const { id } = useParams();
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <button
        onClick={() => navigate(-1)}
        className="mb-8 text-gray-500 hover:text-black font-bold flex items-center gap-2"
      >
        ← BACK TO FLEET
      </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col">
          <span className="text-yellow-500 font-black tracking-widest text-sm uppercase mb-2">
            {vehicle.category}
          </span>
