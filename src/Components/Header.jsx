      ...
      <div className="flex flex-wrap justify-center gap-3 md:gap-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-1">
            <a href="tel:+94775763009" className="hover:underline hover:text-gray-800 transition-colors">
              +94 77 576 3009
            </a>
            <span>|</span>
            <a href="tel:+94753563009" className="hover:underline hover:text-gray-800 transition-colors">
              +94 75 356 3009
            </a>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="mailto:greenwaylanka2021@gmail.com" className="hidden sm:inline hover:underline transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="hidden lg:inline">No.445/1, 2nd Canal Road, Kaduruwela, Polonnaruwa</span>
